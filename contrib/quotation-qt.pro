...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/quotation-cli.cpp \
           src/quotation-tx.cpp \
           src/quotation.cpp \
           src/db.cpp \
           ...
           src/qt/quotation.cpp \
           src/qt/quotationstrings.cpp \
...
RESOURCES += src/qt/quotation.qrc src/qt/quotation_locale.qrc

TRANSLATIONS += src/qt/locale/quotation_bg.ts \
                src/qt/locale/quotation_de.ts \
                src/qt/locale/quotation_en.ts \
                src/qt/locale/quotation_es.ts \
                src/qt/locale/quotation_fi.ts \
                src/qt/locale/quotation_fr.ts \
                src/qt/locale/quotation_it.ts \
                src/qt/locale/quotation_ja.ts \
                src/qt/locale/quotation_pl.ts \
                src/qt/locale/quotation_pt.ts \
                src/qt/locale/quotation_ru.ts \
                src/qt/locale/quotation_sk.ts \
                src/qt/locale/quotation_sv.ts \
                src/qt/locale/quotation_vi.ts \
                src/qt/locale/quotation_zh_CN.ts \
                src/qt/locale/quotation_zh_TW.ts
