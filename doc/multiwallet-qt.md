...
In order to support loading of multiple wallets in quotation-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is quotation.cpp.
...
Changes to quotation.cpp
----------------------
quotation.cpp is the entry point into quotation-qt, and as such, will require some minor modifications to provide hooks for
