Contributing to Quotation Core
============================

The Quotation Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Quotation Core project, and is not to be
confused with overall Quotation Network Protocol consensus changes.

Whether a pull request is merged into Quotation Core rests with the project merge
...
Patches that change Quotation consensus rules are considerably more involved than
...
Where a patch set proposes to change the Quotation consensus, it must have been
...
The project leader is the release manager for each Quotation Core release.
