...
/** Utility functions used by the Quotation Qt UI.
 */
namespace GUIUtil
{
...
// Render Quotation addresses in monospace font
...
// Parse "quotation:" URI into recipient object, return true on successful parsing
