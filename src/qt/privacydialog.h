...
public:
    ...
    void setZQuotationControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzQUOT_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzQUOT_clicked();
    void on_pushButtonZQuotationControl_clicked();
