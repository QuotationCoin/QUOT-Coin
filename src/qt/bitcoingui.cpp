                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Quotation Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quotation address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quotation: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Quotation Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quotation Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Quotation"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quotation addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quotation addresses"));
    ...
    openAction->setStatusTip(tr("Open a Quotation: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quotation Core help message to get a list with possible Quotation command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Quotation Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Quotation network", "", count));
}
...
{
    QString strTitle = tr("Quotation Core"); // default title
...
/** Creates context menu, its actions, and quotations up all the relevant signals for mouse events. */
