...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Quotation Core"),
     ...
     * override -datadir in the quotation.conf file in the default data directory
     * (to be consistent with quotationd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
