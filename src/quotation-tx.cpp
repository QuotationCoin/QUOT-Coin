...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Quotation Core quotation-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quotation-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quotation transaction") + "\n" +
                               "  quotation-tx [options] -create [commands]   " + _("Create hex-encoded quotation transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quotation transaction
