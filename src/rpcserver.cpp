...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Quotation server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Quotation server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Quotation features */
        {"quotation", "masternode", &masternode, true, true, false},
        {"quotation", "listmasternodes", &listmasternodes, true, true, false},
        {"quotation", "getmasternodecount", &getmasternodecount, true, true, false},
        {"quotation", "masternodeconnect", &masternodeconnect, true, true, false},
        {"quotation", "masternodecurrent", &masternodecurrent, true, true, false},
        {"quotation", "masternodedebug", &masternodedebug, true, true, false},
        {"quotation", "startmasternode", &startmasternode, true, true, false},
        {"quotation", "createmasternodekey", &createmasternodekey, true, true, false},
        {"quotation", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"quotation", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"quotation", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"quotation", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"quotation", "getmasternodescores", &getmasternodescores, true, true, false},
        {"quotation", "mnbudget", &mnbudget, true, true, false},
        {"quotation", "preparebudget", &preparebudget, true, true, false},
        {"quotation", "submitbudget", &submitbudget, true, true, false},
        {"quotation", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"quotation", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"quotation", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"quotation", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"quotation", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"quotation", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"quotation", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"quotation", "checkbudgets", &checkbudgets, true, true, false},
        {"quotation", "mnsync", &mnsync, true, true, false},
        {"quotation", "spork", &spork, true, true, false},
        {"quotation", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"quotation", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use quotationd, or the -server option to quotation-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> quotation-cli " + methodname + " " + args + "\n";
}
